...
@section('content')
    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white">
                ...
                <span id="compositeline2" class="pt-1">2345678
                </span>
            </div>
        </div>
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
    ...
    <div class="row row-sm">
            ...
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-0">نسبة احصاتئية الفواتير </h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                    </div>

                </div>
                <div class="card-body" style="width:70%; height:666;">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6">
            <div class="card card-dashboard-map-one" style="
                                            height:275px">
                <label class="main-content-label">نسبة احصاتئية الفواتير</label>
