                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600">ملعومات الفاتوره </label>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($invoices->Total, 2) }}0</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <br><br><br><br>
                        <a style="width: 100px;height:50px" href="#" class="btn btn-danger float-left mt-3 mr-2"
