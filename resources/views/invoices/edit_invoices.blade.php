                    ...
                    <form action="{{ url('invoices/update') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control keyup" id="Amount_Commission"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control keyup" id="Discount" name="Discount"
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control keyup">
                                    <!--placeholder-->
...
@section('js')
    ...
    <script>
        $(".keyup").on('keyup', function() {
            ...
            var Rate_VAT = parseInt($('#Rate_VAT').val());

            // console.log(Amount_Commission);  

            if (Amount_Commission != '' && Discount != '') {
                var resualtAfterTax = parseFloat(Amount_Commission) - parseFloat(Discount);
                var resualtTax = resualtAfterTax * Rate_VAT / 100;

                $('#Value_VAT').val(resualtTax);

                $('#Total').val(resualtTax + resualtAfterTax);
            }
