...
@section('content')
    ...
    @endif
    @if (session()->has('Archive2_invoice'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم الغاء  ارشفة الفاتوره بنجاح",
                    type: "success"
                })
            }
        </script>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20" style="width: 100%">
                <div class="card-header pb-0">
                    ...
                    @can('اضافة فاتوره')
                        <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:#fff"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button style="width: 100px;" aria-expanded="false" aria-haspopup="true"
