                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعه جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_Partial')) }}">الفواتير
                                    المدفوعه جزئيا</a>
                            </li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Archive_invoices')) }}">ارشيف
                                    الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide"
                        href="{{ url('/' . ($page = 'report_invoices')) }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'report_invoices')) }}">تقارير
                                    الفواتير</a>
                            </li>
                        @endcan
